...
import me.berfini.household.databinding.ConditionFragmentBinding

class ConditionFragment : Fragment() {
    private lateinit var binding: ConditionFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.condition_fragment, container, false)
