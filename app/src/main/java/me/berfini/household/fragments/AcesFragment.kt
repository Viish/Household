...
class AcesFragment : Fragment() {
    private lateinit var binding: AcesFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.aces_fragment, container, false)
